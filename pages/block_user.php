...
<div class="container">
    <table class="table-fixed">
        ...
        <tr style="padding: 20px">
            ...
            <th style="padding: 20px">is block</th>
        </tr>
        </thead>
        <form action="" id="block_form">
            ...
            foreach ($users as $user) {
                ...
                <tr>
                    ...
                    <td style="padding: 20px"><?php echo $user['block'] ? 'yes' : 'no'; ?></td>
                </tr>
                <?php
            }
            ?>
    ...
    <button style="background-color: #55a1ff;border-radius: 5px" onclick="blockSave()">
        submit
    </button>
